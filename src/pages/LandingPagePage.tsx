...
<nav className="fixed top-0 w-full z-50 h-16 bg-[#0e141c]/90 backdrop-blur-md flex justify-between items-center px-6">
<div className="flex items-center gap-8">
<motion.span 
  initial={{ opacity: 0, x: -20 }}
  animate={{ opacity: 1, x: 0 }}
  className="text-2xl font-bold text-[#dde3ef] tracking-tighter font-['Space_Grotesk']" 
>Mistletoe</motion.span>
<div className="hidden md:flex items-center gap-6">
<motion.a whileHover={{ y: -2 }} className="text-[#55d8e1] font-bold border-b-2 border-[#55d8e1] font-['Space_Grotesk'] tracking-tight cursor-pointer transition-transform" href="#" >Home</motion.a>
<motion.a whileHover={{ y: -2 }} className="text-[#bbc9ca] hover:text-[#55d8e1] transition-colors duration-200 font-['Space_Grotesk'] tracking-tight cursor-pointer transition-transform" href="#capabilities" >Capabilities</motion.a>
<motion.a whileHover={{ y: -2 }} className="text-[#bbc9ca] hover:text-[#55d8e1] transition-colors duration-200 font-['Space_Grotesk'] tracking-tight cursor-pointer transition-transform" href="#workflow" >Workflow</motion.a>
</div>
</div>
<div className="flex items-center gap-4">
<div className="hidden lg:flex items-center gap-3 mr-4">
<motion.span whileHover={{ rotate: 15 }} className="material-symbols-outlined text-[#bbc9ca] hover:text-[#55d8e1] cursor-pointer" >filter_list</motion.span>
<motion.span whileHover={{ rotate: 15, scale: 1.1 }} className="material-symbols-outlined text-[#bbc9ca] hover:text-[#55d8e1] cursor-pointer" >notifications</motion.span>
<motion.span whileHover={{ rotate: 90 }} className="material-symbols-outlined text-[#bbc9ca] hover:text-[#55d8e1] cursor-pointer" >settings</motion.span>
</div>
<MagneticButton onClick={login} className="primary-gradient text-on-primary font-bold px-5 py-2 rounded-lg text-sm tracking-tight inline-block">Analyze Repo</MagneticButton>
</div>
</nav>
...
<motion.span 
  ...
  className="text-primary font-bold tracking-[0.2em] text-xs mb-6 block uppercase" 
>Automated Insight Engine</motion.span>
<motion.h1 
  initial={{ opacity: 0, scale: 0.95 }}
  animate={{ opacity: 1, scale: 1 }}
  transition={{ delay: 0.3, duration: 0.5 }}
  className="font-headline text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-[-0.04em] leading-[0.9] mb-8 text-glow" 
>
...
<motion.p 
  ...
  className="font-body text-on-surface-variant text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed" 
>
...
>
<MagneticButton onClick={login} className="primary-gradient text-on-primary font-bold px-8 py-4 rounded-lg text-lg w-full sm:w-auto shadow-lg shadow-primary/20 text-center inline-block">Mulai Analisis</MagneticButton>
<MagneticButton className="border border-outline-variant hover:bg-surface-container-high transition-all text-on-surface font-semibold px-8 py-4 rounded-lg text-lg w-full sm:w-auto">
                        Lihat Dokumentasi
</MagneticButton>
</motion.div>
</motion.div>
...
<motion.div 
  ...
  className="mt-20 w-full max-w-6xl aspect-[16/9] rounded-xl overflow-hidden bg-surface-container-low border border-outline-variant/20 shadow-2xl relative"
>
...
<motion.div 
  ...
  viewport={{ once: true }}
  transition={{ duration: 0.5 }}
  className="md:col-span-7 bg-surface-container-low rounded-xl p-8 flex flex-col justify-between border border-outline-variant/10 group hover:border-primary/30 transition-all"
>
...
<motion.div 
  ...
  className="md:col-span-5 bg-surface-container-high rounded-xl p-8 flex flex-col justify-between border border-outline-variant/10"
>
<div className="space-y-6">
...
<motion.div 
  ...
  className="md:col-span-4 bg-surface-container-low rounded-xl p-6 border border-outline-variant/10"
>
...
<motion.div 
  ...
  className="md:col-span-4 bg-primary-container/10 rounded-xl p-6 border border-primary/20 flex items-center justify-center cursor-pointer"
>
...
<section className="py-32 bg-surface-container-lowest overflow-hidden" id="workflow">
...
<motion.div 
  ...
  className="w-24 h-24 rounded-full bg-surface-container-high border-2 border-outline-variant flex items-center justify-center mb-8 z-10 transition-colors hover:border-primary cursor-pointer"
>
...
<motion.div 
  whileHover={{ scale: 1.1, rotate: -10 }}
  className="w-24 h-24 rounded-full bg-surface-container-high border-2 border-primary flex items-center justify-center mb-8 z-10 shadow-[0_0_30px_rgba(85,216,225,0.2)] cursor-pointer"
>
...
<motion.div 
  ...
  className="max-w-5xl mx-auto glass-panel rounded-3xl p-12 border border-outline-variant/20 relative overflow-hidden"
>
<div className="absolute top-0 right-0 p-8 opacity-10">
<motion.span 
  animate={{ rotate: 360 }} 
  transition={{ repeat: Infinity, duration: 40, ease: "linear" }}
  className="material-symbols-outlined text-[120px] origin-center inline-block" 
...
<MagneticButton onClick={login} className="primary-gradient text-on-primary font-bold px-10 py-5 rounded-lg text-lg shadow-xl shadow-primary/20 whitespace-nowrap text-center inline-block">Mulai Sekarang — Gratis</MagneticButton>
</div>
</div>
</motion.div>
{/* Simple Footer Links */}
