...
<button onClick={login} className="px-4 py-1.5 border border-outline-variant rounded text-sm hover:bg-surface-container-high transition-colors">
            Login
        </button>
</div>
</header>
...
<button onClick={login} className="px-10 py-4 bg-[#24292e] text-white font-headline font-bold rounded-xl transition-all hover:shadow-[0_0_30px_rgba(36,41,46,0.4)] hover:scale-[1.02] active:scale-95 flex items-center gap-3 text-lg">
