...
<button onClick={login} className="text-[#bbc9ca] hover:text-[#dde3ef] transition-colors font-medium px-4 py-2 scale-95 active:scale-100 transition-transform">Sign In</button>
<button onClick={login} className="bg-gradient-to-br from-primary to-primary-container text-on-primary font-bold px-6 py-2.5 rounded-md scale-95 active:scale-100 transition-transform">Get Started</button>
</div>
</header>
